...
export type Endpoint4_8Output = EffectValue<ReturnType<RawClient["server.session"]["session.move"]>>
export type SessionMoveOperation<E = never> = (input: Endpoint4_8Input) => Effect.Effect<Endpoint4_8Output, E>
...
export type Endpoint4_21Output = EffectValue<ReturnType<RawClient["server.session"]["session.context.entry.put"]>>
...
export type Endpoint4_22Output = EffectValue<ReturnType<RawClient["server.session"]["session.context.entry.remove"]>>
